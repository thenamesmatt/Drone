...
void setup()
{
  ...
  // Create and set pin and value 0 (off)
  // SoftPWMSet(12,  75);
  // SoftPWMSet(5,  255);
  // SoftPWMSet(11, 255);
  // SoftPWMSet(13, 255);
  ...
  // SoftPWMSetFadeTime(12, 0, 0);
  // SoftPWMSetFadeTime(5,  0, 0);
  // SoftPWMSetFadeTime(11, 0, 0);
...
{
  int val;
  val = IBus.readChannel(3, 0, 255, 0);
  // THIS PRINTS THE DATA FROM RECIVER
  Serial.println(val);
  // Turn on - set to 100%
  // SoftPWMSetPercent(12, val);
  // SoftPWMSetPercent(5,  val);
  // SoftPWMSetPercent(11, val);
  // SoftPWMSetPercent(13, val);
